...
pub use messages::{
    ...
    EntryKind, PermissionMode, RemoteConfig, ServerMessage, SessionMode, SessionSummary, SlashCommand,
    Skill, SkillKind, SkillScope, SubAgent, ToolApproval, UsageWindow, WorkspaceSummary,
};
