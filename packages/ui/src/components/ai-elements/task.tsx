...
/**
 * Vercel AI Elements' Task component — the official registry source (registry.ai-sdk.dev/task.json),
 * with only the shadcn/lib import paths repointed to this package. Groups a run of agent steps under
 * one collapsible header. See `../../chat/tool-group.tsx` for how the chat view drives it.
 */
